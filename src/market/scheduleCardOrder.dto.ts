...
export const PATH_MARKET_CARD_ORDER = "/qqlx/market/card/order";
/** 微信支付流程
 * @step1 创建本地支付订单
 * @step2 创建微信支付订单（未创建成功）
 * @step3 如果微信支付订单接口正常，则更新本地支付订单为（创建成功）
 */
export type postScheduleCardOrderDto = { schema: ScheduleCardOrder; corpId: string };
 ...
 * @step3 返回本地支付订单
 */
export type getScheduleCardOrderDto = { page: Page; corpId: string };
 ...
 * @step2 更新本地支付订单
 */
export type patchScheduleCardOrderDto = { corpId: string };
