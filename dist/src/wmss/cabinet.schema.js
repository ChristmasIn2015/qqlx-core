...
(function (ENUM_POUNDS_FORMULA) {
    ...
    /** 圆管（支） */
    ENUM_POUNDS_FORMULA[ENUM_POUNDS_FORMULA["TS_WFGG_REGULAR"] = 3004] = "TS_WFGG_REGULAR";
    /** 正方管（支） */
    ENUM_POUNDS_FORMULA[ENUM_POUNDS_FORMULA["TS_FG_REGULAR"] = 3005] = "TS_FG_REGULAR";
    /** 矩形方管（支） */
    ENUM_POUNDS_FORMULA[ENUM_POUNDS_FORMULA["TS_JXFG_REGULAR"] = 3006] = "TS_JXFG_REGULAR";
    /** 等边角钢（米） */
