...
export declare const PATH_OA_LINEACCESS = "/qqlx/oa/line/access";
export type postLineAccessDto = {
    lineId: string;
    accesses: Access[];
};
export type postLineAccessRes = null;
export type LineAccessJoined = LineAccess & {
    joinAccess: AccessJoined;
};
export type getLineAccessDto = {
    lineId: string;
};
export type getLineAccessRes = LineAccessJoined[];
export type deleteLineAccessDto = {
    entityId: string;
};
export type deleteLineAccessRes = null;
export declare const PATH_OA_LINEBOX = "/qqlx/oa/line/box";
export type postLineBoxDto = LineBox;
export type postLineBoxRes = null;
export type deleteLineBoxDto = {
    entityId: string;
};
export type deleteLineBoxRes = null;
export type LineBoxJoined = LineBox & {
    joinBox: BoxJoined;
};
export declare const PATH_OA_LINE = "/qqlx/oa/line";
